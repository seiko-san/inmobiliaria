function gestiondueño() {
    var detener = 2500;
   
    $.ajax({
        type: "get",
        url: "./vistas/agregardueño.php",
        beforeSend: function () {
            $('#contenido').html('<div class="loading" align="center"><img src="../img/loading/cargando2.gif" alt="loading" /><br/>Un momento, por favor...</div>');
